        ...
        >
          ...
          >
            ...
            <View style={styles.form}>
              ...
              <Button
                title={isLoading ? "Please wait..." : (pendingVerification ? "Sign In" : "Continue")}
              ...
              <View style={styles.footer}>
                <Text style={[styles.footerText, { color: isDark ? 'rgba(255,255,255,0.5)' : '#666' }]}>
                  {pendingVerification ? "Wrong email? " : "Don't have an account? "}
                </Text>
                <Pressable onPress={() => {
                  ...
                  <Text style={[styles.footerLink, { color: colors.accent }]}>
                    {pendingVerification ? "Change email" : "Sign Up"}
                  </Text>
                </Pressable>
              </View>
            </View>
